...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
   ...
   public boolean mHideConfirmButton = false;
   ...
   public OnSweetClickListener mNeutralClickListener;
   public boolean mCloseFromCancel;
   public boolean mHideKeyBoardOnDismiss = true;
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      // this is where I set the font to each textView
      Typeface face = ResourcesCompat.getFont(getContext(), R.font.cairo_regular);
